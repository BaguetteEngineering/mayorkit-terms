...
Feel free to contact us if you have any questions about MayorKit’s Privacy Policy or practices. You may contact us at [hello@mayorkit.com](mailto:hello@mayorkit.com) or at our mailing address below:
...
Although most changes are likely to be minor, MayorKit may change its Privacy Policy from time to time, and in MayorKit's sole discretion. MayorKit encourages visitors to frequently check this page for any changes to its Privacy Policy. If a visitor objects to any of the changes to the Policy, the visitor must cease using the Service and can request that MayorKit remove the Personal Data.

## Mandatory [CNIL](https://www.cnil.fr) notice for French visitors

### Données personnelles

Bastien Petit ("MayorKit") dispose de moyens informatiques destinés à l'exécution du Service tel que défini ci-dessus.
...
Vous pouvez accéder aux informations vous concernant en vous adressant à [hello@mayorkit.com](mailto:hello@mayorkit.com).
